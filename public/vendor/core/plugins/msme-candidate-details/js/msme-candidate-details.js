...
let msmeUtils = {
    ...
    bindEvent: function () {
        $(document).on('change', 'input[name="candidate_msme_ref_id"], #scheme', function (e) {
            if($('input[name="candidate_msme_ref_id"]').val() != "" && $("#scheme option:selected").text())
                msmeUtils.getMsmeCandidateData(e);            
        });        
    },
    getMsmeCandidateData:function(e){
        let target = e.target;
        let msmeId = $('input[name="candidate_msme_ref_id"]').val();
            ...
            headers: {
                        ...
                        success: (response) => {
    						...
    						if (response && response.data) {
                                let candidateDetails = response.data;

...
return [
     ...
     */
    'welcome'      => [
        'templateTitle' => 'Impiger CMS',
        'title'         => 'Impiger CMS',
        'message'       => 'Welcome to Impiger CMS. Before getting started, we need some information on the database. You will need to know the following items before proceeding.',
        'next'          => 'Let\'s go',
    ],
    ...
    'create'                => 'Create',
    'install_success'       => 'Install Impiger CMS successfully!',

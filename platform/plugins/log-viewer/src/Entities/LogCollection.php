...
namespace Impiger\LogViewer\Entities;

use Impiger\LogViewer\Contracts\Utilities\Filesystem as FilesystemContract;
use Impiger\LogViewer\Contracts\Utilities\Filesystem;
use Impiger\LogViewer\Exceptions\LogNotFoundException;
...
class LogCollection extends Collection
{
    ...
    {
        $this->setFilesystem(app('impiger::log-viewer.filesystem'));

...
namespace Impiger\Blog\Forms;

use Impiger\Base\Enums\BaseStatusEnum;
use Impiger\Base\Forms\Fields\TagField;
use Impiger\Base\Forms\FormAbstract;
use Impiger\Blog\Forms\Fields\CategoryMultiField;
    ...
    public function buildForm()
    {
        ...
        $this
            ...
            ->add('format_type', 'customRadio', [
                ...
                'label_attr' => ['class' => 'control-label required'],
                // Customized by Harish Muraleetharan. MB-8980

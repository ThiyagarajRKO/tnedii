...
class Workflow {
        ...
        _self.$body.on('click', '.apply-workflow-process', event => {
            ...
            if(_self.selectEl){
                $.each(_self.selectEl,function(index,value){
                    Workflow.getOptions(value.table,value.elm,value.condn);
                })
            }
            },500)
    ...
    doModal(data) {
        ...
        <input class="form-control  datepicker" data-date-format="yyyy" required="required" name="` + inputName + `" type="text" value="" autocomplete="off" aria-required="true"
...
//            CustomScript.initCustomSelect2();
        return $.fn.dialogue({
            ...
            buttons: [
                ...
                {
                    text: "Submit", class: "float right btn btn-info", id: $.utils.createUUID(), click: function ($modal) {

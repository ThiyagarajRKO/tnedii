...
namespace Impiger\SimpleSlider\Http\Controllers;
...
use Impiger\SimpleSlider\Forms\SimpleSliderForm;
use Impiger\SimpleSlider\Http\Requests\SimpleSliderRequest;
...
use Exception;
use Impiger\SimpleSlider\Tables\SimpleSliderTable;

...
class ProgramWiseReportsTable extends TableAbstract {
    ...
    public function query() {
        ...
        $query = $model->select($select)->join('trainees AS T', 'T.entrepreneur_id', '=', 'entrepreneurs.id')->join('training_title AS TT', 'TT.id', '=', 'T.training_title_id')
                ->whereNull(['entrepreneurs.deleted_AT','T.deleted_at','TT.deleted_at'])->groupBy('TT.id');

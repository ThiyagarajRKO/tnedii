class LanguageManagement {
    ...
    bindEventToElement() {
        ...
        $(document).on("change", "#language_id", (event) => {
            let language = $(event.currentTarget)
        ...
        $(document).on("click", "#btn-language-submit", (event) => {
            ...
            LanguageManagement.createOrUpdateLanguage(
                0,
                name,
                locale,
                code,
        ...
        languageTable.on("click", ".deleteDialog", (event) => {
            ...
            $(".delete-crud-entry").data(
                "section",
                $(event.currentTarget).data("section")
            );
                    ...
                    if (data.error) {
                        ...
                        star.replaceWith(
                            '<a data-section="' +
                                ...
                                "?lang_id=" +
                                star.data("id") +
                                '" class="set-language-default tip" data-original-title="Choose ' +
                                star.data("name") +
                                ' as default language">' +

class LanguageGlobalManagement {
    init() {
        ...
        $("#confirm-change-language-modal .btn-warning.float-left").on(
            "click",
            (event) => {
                event.preventDefault();
                languageChoiceSelect
                    .val(languageChoiceSelect.data("prev"))
                    .trigger("change");
        ...
        $("#confirm-change-language-button").on("click", (event) => {
            ...
            $.ajax({
                url: $("div[data-change-language-route]").data(
                ...
                success: (data) => {
                    ...
                    if (!data.error) {
                        ...
                        $("#confirm-change-language-modal").modal("hide");
                        languageChoiceSelect
                            .data("prev", languageChoiceSelect.val())
                            .trigger("change");
                    }

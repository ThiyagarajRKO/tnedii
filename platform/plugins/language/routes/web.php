...
Route::group(['namespace' => 'Impiger\Language\Http\Controllers', 'middleware' => ['web', 'core']], function () {
    ...
    Route::group(['prefix' => 'languages'], function () {
        ...
        if (is_plugin_active('multidomain')) {
            if (!empty(app(\Impiger\Multidomain\Multidomain::class)->getCurrentAdminDomainId())) {
                Route::get('change-data-language/{ref_lang}/{ref_domain}', [
            ...
            {
                Route::get('change-data-language/{ref_lang}', [
                    'as'         => 'languages.change.data.language',
                    'uses'       => 'LanguageController@getChangeDataLanguage',
                    'permission' => false,
                ]);

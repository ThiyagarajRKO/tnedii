...
namespace Impiger\Crud\Supports;
...
class CrudDashboardWidgetInstance extends DashboardWidgetInstance
{
    ...
    public function init($widgets, $widgetSettings)
    {
        ...
        if ($this->type === 'widget') {
            ...
            $data = [
                'id'   => $widget->id,
                'type' => $this->type,
                'view' => view('plugins/crud::widgets.custom-base', compact('widget', 'widgetSetting'))->render(),
            ];
        ...
        $view = ($this->hasSubStats) ? "plugins/crud::widgets.custom-stats" : "core/dashboard::widgets.stats";
    ...
    {
        $view = "plugins/crud::widgets.website-stats";
        $widgetSetting = null;

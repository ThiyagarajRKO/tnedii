...
{!! Form::open(array('url'=>'admin/cruds/conn/'.$module_name, 'id'=>'conn_form','class'=>'form-vertical' ,'parsley-validate'=>'','novalidate'=>' ')) !!}
	<div id="result"></div>
...
$(document).ready(function(){
	...
	$("#db").jCombo("{{ URL::to('admin/cruds/combotable') }}",
	{ selected_value : "{{ $f['db'] }}" });

	
	<?php $display = explode("|", $f['display']); ?>

	$("#key").jCombo("{{ URL::to('admin/cruds/combotablefield') }}?table=",

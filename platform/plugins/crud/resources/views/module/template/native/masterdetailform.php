        ...
        <thead>
			<tr>
				@foreach ($subform[\'tableGrid\'] as $t)
					@if($t[\'view\'] ==\'1\' && $t[\'field\'] !=\''.$info['master_key'].'\' && $t[\'field\'] != $relation_key)
						<th>{{ $t[\'label\'] }}</th>
					@endif
				@endforeach
				<th></th>	
        ...
        @if(count($subform[\'rowData\'])>=1)
            ...
            <tr class="clone clonedInput">
			 ...
			 @foreach ($subform[\'tableGrid\'] as $field)
				 @if($field[\'view\'] ==\'1\' && $field[\'field\'] !=\''.$info['master_key'].'\' && $field[\'field\'] != $relation_key)
				 <td>					 
				 	{!! bulkForm($field[\'field\'] , $subform[\'tableForm\'] , $rows->{$field[\'field\']}) !!}							 
				 </td>
				 @endif					 
		...
		@else
            <tr class="clone clonedInput">
			 ...
			 @foreach ($subform[\'tableGrid\'] as $field)
				 ...
				 @if($field[\'view\'] ==\'1\' && $field[\'field\'] !=\''.$info['master_key'].'\' && $field[\'field\'] != $relation_key)
				 <td>					 
				 	{!! bulkForm($field[\'field\'] , $subform[\'tableForm\'] ) !!}							 
				 </td>
				 @endif					 
        ...
        <tbody>
            ...
            <tr>
			 ...
			 @foreach ($subgrid[\'tableGrid\'] as $field)
				 @if($field[\'view\'] ==\'1\' )		
				 	<td> {!! formatRows($row->$field[\'field\'],$field) !!}</td>				 
				 @endif					 

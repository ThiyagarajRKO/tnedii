...
class {controller}Controller extends SximoController {
	...
	public function index( Request $request )
	{
		...
		$this->grab( $request) ;
        if (!(Auth::user()->hasPermission('{class}.index')))
	...
	public function destroy( $request)
	{
		...
		if(is_array($request->input('ids')))
		{
			...
			{masterdetaildelete}
			auditTrail( $request , "ID : ".implode(",",$request->input('ids'))."  , Has Been Removed Successfull");
			// redirect
	...
	public static function display(  )
	{
		...
		if($mode == 'view')
		{
			...
			{
				$data['row'] =  $row;
				$data['fields'] 		=  fieldLang($info['config']['grid']);
				$data['id'] = $id;

...
(($) => {
    ...
    $body.on(
        "click",
        "form.import-field-group button.btn.btn-secondary.action-item:nth-child(2)",
        (event) => {
            ...
            reader.onload = (e) => {
                ...
                $.ajax({
                    ...
                    success: (res) => {
                        ...
                        if (!res.error) {
                            if (
                                window.LaravelDataTables["table-custom-fields"]
                            ) {
                    ...
                    error: () => {
                        Impiger.showError("Some error occurred");
                    },
                });
            };
        }

...
namespace Impiger\RequestLog\Http\Controllers;
...
use Impiger\RequestLog\Tables\RequestLogTable;
use Impiger\RequestLog\Tables\RequestLogStatsTable; /* @Customized By Ramesh Esakki */
use Exception;
...
class RequestLogController extends BaseController
{
    ...
    /**
     * @param RequestLogStatsTable $dataTable
     * @return Factory|View
     * @throws Throwable
     */
    public function index(RequestLogStatsTable $dataTable)
    {
     ...
     * @throws Throwable
     */
    public function detail(RequestLogTable $dataTable)
    {
        page_title()->setTitle(trans('plugins/request-log::request-log.name'));

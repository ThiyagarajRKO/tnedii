    ...
    public function boot(FormBuilder $formBuilder)
    {
        ...
        $this->app->booted(function () use ($formBuilder) {
            ...
            if (function_exists('add_shortcode')) {
                ...
                $that = $this;
                CrudHelper::declareShortCode($that, 'training-title-financial-detail');
            }
        });
    }
        ...
        if (defined('THEME_OPTIONS_MODULE_SCREEN_NAME')) {
            $this->app->booted(function () {
                Theme::asset()
                    ->container('footer')
                    ->usePath(false)
                    ->add('training-title-financial-detail-custom-js', asset('vendor/core/plugins/training-title-financial-detail/js/training-title-financial-detail.js'), ['jquery'], [], '1.0.0');
            });
        }
    }

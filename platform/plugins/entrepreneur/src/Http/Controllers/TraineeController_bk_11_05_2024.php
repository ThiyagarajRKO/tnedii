...
class TraineeController extends BaseController
{
    ...
    public function postImport(Request $request, BaseHttpResponse $response)
    {
           try {
            ...
            $bulkUpload = new ImportMultiSheetNew(new \Impiger\Entrepreneur\Models\Trainee,[new \Impiger\Entrepreneur\Models\Entrepreneur,new \Impiger\Entrepreneur\Models\Trainee]);
            //echo "<pre>";
            //print_r($bulkUpload);
            //echo "</pre>";
            //exit;

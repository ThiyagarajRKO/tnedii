    ...
    DataTable.ext.buttons.export = {
        ...
        text: (dt) => {
            return (
                ...
                dt.i18n(
                    "buttons.export",
                    ImpigerVariables.languages.tables.export
                ) +
                '&nbsp;<span class="caret"/>'
            );
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: (dt) => {
            return (
                ...
                dt.i18n("buttons.csv", ImpigerVariables.languages.tables.csv)
            );
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: (dt) => {
            return (
                ...
                dt.i18n(
                    "buttons.reset",
                    ImpigerVariables.languages.tables.reset
                )
            );
        },
    ...
    DataTable.ext.buttons.reload = {
        ...
        text: (dt) => {
            return (
                ...
                dt.i18n(
                    "buttons.reload",
                    ImpigerVariables.languages.tables.reload
                )
            );
        },
    ...
    if (typeof DataTable.ext.buttons.colvis !== "undefined") {
        $.extend(DataTable.ext.buttons.colvis, {
            text: (dt) => {
                return (
                    '<i class="fa fa-eye"></i> ' +
                    dt.i18n("buttons.colvis", "Visibile")
                );
            },
        });
    }
    ...
    class TableManagement {
        ...
        handleActionsRow() {
            ...
            $(document).on("click", ".delete-many-entry-trigger", (event) => {
                ...
                if (ids.length === 0) {
                    Impiger.showError(
                        ImpigerVariables.languages.tables.please_select_record
                    );
                    return false;
                }

...
@include('core/table::partials.modal-item', [
    'type' => 'danger',
    'name' => 'modal-confirm-activation',
    'title' => trans('plugins/crud::crud.confirm_activation'),
    'content' => trans('plugins/crud::crud.confirm_activation_msg'),
    'action_name' => trans('plugins/crud::crud.activation'),
    'action_button_attributes' => [
        'class' => 'row-activation-crud-entry',
    ],
])

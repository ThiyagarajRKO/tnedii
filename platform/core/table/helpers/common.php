...
if (!function_exists('table_actions')) {
     ...
     * @param string $edit
     * @param string $delete
     * @param \Impiger\Base\Models\BaseModel $item
     * @param string $extra
     * @return string
     * @throws Throwable
     *  @customized by Sabari Shankar Parthiban
     */
    function table_actions($edit, $delete, $item, $extra = null,$suffix = null): string
    {
        return view('core/table::partials.actions', compact('edit', 'delete', 'item', 'extra','suffix'))->render();
    }
}

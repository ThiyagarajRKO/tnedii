...
namespace Impiger\Setting\Http\Controllers;

use Assets;
use Impiger\Base\Supports\Core;
use Impiger\Base\Supports\Language;
use Impiger\Setting\Http\Requests\EmailTemplateRequest;
use Impiger\Setting\Http\Requests\LicenseSettingRequest;
use Impiger\Setting\Http\Requests\MediaSettingRequest;
use Impiger\Setting\Http\Requests\SendTestEmailRequest;
use Impiger\Setting\Http\Requests\SettingRequest;
...
class SettingController extends BaseController
{
    ...
    {
        /* Customized by Vijayaragavan Ambalam to remove license

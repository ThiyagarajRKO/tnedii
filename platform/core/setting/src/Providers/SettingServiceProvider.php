...
namespace Impiger\Setting\Providers;

use Impiger\Base\Supports\Helper;
use Impiger\Base\Traits\LoadAndPublishDataTrait;
use Impiger\Setting\Facades\SettingFacade;
use Impiger\Setting\Models\Setting as SettingModel;
use Impiger\Setting\Repositories\Caches\SettingCacheDecorator;
use Impiger\Setting\Repositories\Eloquent\SettingRepository;
use Impiger\Setting\Repositories\Interfaces\SettingInterface;
use Impiger\Setting\Supports\SettingsManager;

...
return [
    ...
    'general'                      => [
        ...
        'session_idle_check_time'               => 'Session idle check time (minutes)', // @customized By Ramesh Esakki
        'default_country'               => 'Default Country', // @customized By Ramesh Esakki
        'site_description'               => 'Site Description', // @customized By Sabari Shankar Parthiban
    ],
    'email'                        => [
        'subject'                       => 'Subject',
        'content'                       => 'Content',
        ...
        'template_user'             => 'Email template user',
        'template_user_description' => 'Template for user of emails',
        'default'                     => 'Default',

        ...
        <li class="collapsed" id="node_sub_{{ $elementKey  }}_{{ $subKey }}">
            ...
            <ul>
                ...
                <li class="collapsed" id="node_sub_sub_{{ $subSubKey }}">
                    <input type="checkbox" class="hrv-checkbox" id="checkSelect_sub_sub_{{ $elementKey }}_{{ $subKey }}_{{ $subSubKey }}" name="flags[]" value="{{ $flags[$subSubElements]['flag'] }}" @if (in_array($flags[$subSubElements]['flag'], $active)) checked @endif>
                           <label for="checkSelect_sub_sub_{{ $elementKey }}_{{ $subKey }}_{{ $subSubKey }}" class="label label-success nameMargin">{{ $flags[$subSubElements]['name'] }}</label>

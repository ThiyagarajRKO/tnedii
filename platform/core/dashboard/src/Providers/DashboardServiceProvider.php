...
namespace Impiger\Dashboard\Providers;

use Impiger\Base\Supports\Helper;
use Impiger\Base\Traits\LoadAndPublishDataTrait;
use Impiger\Dashboard\Models\DashboardWidget;
use Impiger\Dashboard\Models\DashboardWidgetSetting;
use Impiger\Dashboard\Repositories\Caches\DashboardWidgetCacheDecorator;
use Impiger\Dashboard\Repositories\Caches\DashboardWidgetSettingCacheDecorator;
use Impiger\Dashboard\Repositories\Eloquent\DashboardWidgetRepository;
use Impiger\Dashboard\Repositories\Eloquent\DashboardWidgetSettingRepository;

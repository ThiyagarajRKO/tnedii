            ...
            success: (res) => {
                ...
                if (!res.error) {
                    ...
                    if (el.find(".scroller").length !== 0) {
                        Impiger.callScroll(el.find(".scroller"));
                    }
    ...
    init() {
        ...
        list_widgets.on("change", ".number_record .numb", (event) => {
            ...
            if (!isNaN(paginate)) {
                ...
                Impiger.showError("Please input a number!");
            }
        });
        ...
        list_widgets.on("click", ".btn_change_paginate", (event) => {
            ...
            BDashboard.loadWidget(
                $(event.currentTarget)
                    .closest(".portlet")
                    .find(".portlet-body"),
                $(event.currentTarget).closest(".widget_item").attr("data-url"),
                { paginate: paginate }
            );
        });
            ...
            (event) => {
                ...
                if (state === "expand") {
                    _self
                        ...
                        .addClass("expand");
                    BDashboard.loadWidget(
                        _self.closest(".portlet").find(".portlet-body"),

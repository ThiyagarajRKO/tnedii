...
return [
    ...
    'default-theme'             => env('DEFAULT_THEME', 'bluegrey'),
    'base_name'                 => env('APP_NAME', 'Impiger Technologies'),
    'logo'                      => '/vendor/core/core/base/images/logo_white.png',
    'favicon'                   => '/vendor/core/core/base/images/favicon.png',
    'powered_logo'              => '/vendor/core/core/base/images/edii_logo_powered.png', /*Customized by Vijayaragavan.Ambalam*/
    'powered_url'               => 'https://impigertech.com', /*Customized by Vijayaragavan.Ambalam*/
    'editor'                    => [
        'ckeditor' => [
            'js' => [
    ...
    'date_format'                 => [
        'date'      => env('CMS_DATE_FORMAT', 'M j, Y'),
        'mysql_date'      => env('CMS_DATE_FORMAT', 'Y-m-d'),
        'date_time' => env('CMS_DATE_TIME_FORMAT', 'M j, Y h:i A'),
        'program_date' => env('CMS_PROGRAM_DATE_FORMAT', 'Do MMM YYYY'),
        'js'        => [
    ...
    'enabled_rtl_for_admin_panel' => env('ENABLED_RLT_FOR_ADMIN_PANEL', false),
    'demo' => [
        'account' => [
            'username' => env('CMS_DEMO_ACCOUNT_USERNAME', 'impiger'),
            'password' => env('CMS_DEMO_ACCOUNT_PASSWORD', 'RSVH#123'),
        ],
    ],
    'google_fonts'                => [
        'Aclonica',

...
use Impiger\Base\Facades\DashboardMenuFacade;
use Impiger\Base\Facades\PageTitleFacade;
use Impiger\Base\Supports\Editor;
...
if (!function_exists('dashboard_menu')) {
    /**
     * @return \Impiger\Base\Supports\DashboardMenu
     */

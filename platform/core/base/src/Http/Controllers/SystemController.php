...
namespace Impiger\Base\Http\Controllers;
...
use Impiger\Base\Supports\MembershipAuthorization;
use Impiger\Base\Supports\SystemManagement;
use Impiger\Base\Tables\InfoTable;

...
use Impiger\Base\Exceptions\Handler;
use Impiger\Base\Facades\MacroableModelsFacade;
use Impiger\Base\Http\Middleware\CoreMiddleware;
use Impiger\Base\Http\Middleware\DisableInDemoModeMiddleware;
use Impiger\Base\Http\Middleware\HttpsProtocolMiddleware;
use Impiger\Base\Http\Middleware\LocaleMiddleware;
use Impiger\Base\Models\MetaBox as MetaBoxModel;
use Impiger\Base\Repositories\Caches\MetaBoxCacheDecorator;
use Impiger\Base\Repositories\Eloquent\MetaBoxRepository;
use Impiger\Base\Repositories\Interfaces\MetaBoxInterface;
use Impiger\Base\Supports\BreadcrumbsManager;
use Impiger\Base\Supports\CustomResourceRegistrar;
use Impiger\Base\Supports\Helper;
use Impiger\Base\Traits\LoadAndPublishDataTrait;
use Impiger\Setting\Providers\SettingServiceProvider;
...
class BaseServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->make('config')->set([
            'session.cookie'                                     => 'impiger_session',

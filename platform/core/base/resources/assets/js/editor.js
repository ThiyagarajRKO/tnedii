class EditorManagement {
    initCkEditor(element, extraConfig) {
        ...
        if (
            typeof RV_MEDIA_URL.filebrowserImageBrowseUrl === "undefined" ||
    ...
    initTinyMce(element) {
        tinymce.init({
            ...
            resize: "vertical",
            plugins:
                "code autolink advlist visualchars link image media table charmap hr pagebreak nonbreaking anchor insertdatetime lists textcolor wordcount imagetools  contextmenu  visualblocks",
        ...
        $(document).on("click", ".show-hide-editor-btn", (event) => {
            ...
            if ($result.hasClass("editor-ckeditor")) {
                if (
                    ...
                    typeof CKEDITOR.instances[_self.data("result")] !==
                        "undefined"
                ) {

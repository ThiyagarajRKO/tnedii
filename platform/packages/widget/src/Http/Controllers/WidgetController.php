...
namespace Impiger\Widget\Http\Controllers;

use Assets;
use Impiger\Base\Http\Controllers\BaseController;
use Impiger\Base\Http\Responses\BaseHttpResponse;
use Impiger\Widget\Factories\AbstractWidgetFactory;
use Impiger\Widget\Repositories\Interfaces\WidgetInterface;
use Impiger\Widget\WidgetId;
use Exception;
...
class WidgetController extends BaseController
{
    ...
    public function __construct(WidgetInterface $widgetRepository)
    {
        ...
        $this->theme = Theme::getThemeName() . $this->getCurrentLocaleCode() . $this->getCurrentDomainId();
    }
    ...
    public function showWidget(Request $request, Application $application)
    {
        ...
        $factory = $application->make('impiger.widget');

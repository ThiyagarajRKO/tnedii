...
namespace Impiger\Widget\Providers;

use Impiger\Base\Supports\Helper;
use Impiger\Base\Traits\LoadAndPublishDataTrait;
use Impiger\Widget\Factories\WidgetFactory;
use Impiger\Widget\Misc\LaravelApplicationWrapper;
use Impiger\Widget\Models\Widget;
use Impiger\Widget\Repositories\Caches\WidgetCacheDecorator;
use Impiger\Widget\Repositories\Eloquent\WidgetRepository;
use Impiger\Widget\Repositories\Interfaces\WidgetInterface;
use Impiger\Widget\WidgetGroupCollection;
use Impiger\Widget\Widgets\Text;
...
class WidgetServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('impiger.widget', function () {
            return new WidgetFactory(new LaravelApplicationWrapper);
        });

        $this->app->singleton('impiger.widget-group-collection', function () {

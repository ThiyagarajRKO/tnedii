...
use Impiger\Theme\Exceptions\UnknownLayoutFileException;
use Impiger\Theme\Exceptions\UnknownPartialFileException;
use Impiger\Theme\Exceptions\UnknownThemeException;
use Closure;
use Exception;
use File;
...
class Theme implements ThemeContract
{
    ...
    public function render($statusCode = 200)
    {
        ...
        $content->withHeaders([
            'Author'            => 'Impiger Technologies (contact@impigertech.com)',
            'Author-Team'       => 'https://impigertech.com',
            'CMS'               => 'Impiger CMS',

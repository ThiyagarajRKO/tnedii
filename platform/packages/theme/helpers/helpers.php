...
use Impiger\Theme\Facades\AdminBarFacade;
use Impiger\Theme\Facades\ThemeOptionFacade;
...
if (!function_exists('theme_option')) {
    /**
     * @return \Impiger\Theme\ThemeOption|string
     */
...
if (!function_exists('admin_bar')) {
    /**
     * @return Impiger\Theme\Supports\AdminBar
     */
    function admin_bar()
    {

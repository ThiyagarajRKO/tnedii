...
namespace Impiger\SeoHelper\Entities\Twitter;

use Impiger\SeoHelper\Contracts\Entities\MetaCollectionContract;
use Impiger\SeoHelper\Contracts\Entities\TwitterCardContract;
use Impiger\SeoHelper\Exceptions\InvalidTwitterCardException;

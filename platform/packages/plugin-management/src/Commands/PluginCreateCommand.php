...
namespace Impiger\PluginManagement\Commands;

use Impiger\PluginManagement\Services\PluginService;
use File;
...
class PluginActivateAllCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'cms:plugin:create';
     ...
     * @var string
     */
    protected $description = 'Create plugins in /plugins directory';

  ...
  var calendar = new FullCalendar.Calendar(calendarEl, {
   ...
   /* eventTimeFormat: {
    ...
    events: [
        ...
        {
            title: '<div class="each-event" style="background-image:url({{ RvMedia::getImageUrl($training->training_background_image_name, '', false, RvMedia::getDefaultImage()) }})"><div class="event-inner"><a href="{{$training->training_gallery_url_en}}" class="gal">View Gallery</a><h3><a href="/training?id={{$training->id}}" style="color:inherit;">{{$training->name}}</a></h3><h4>VENUE : {{$training->venue}}</h4></div></div>',
						...
						<div role="tabpanel" class="tab-pane active" id="home">
							...
							<div class="cal-wrapper">
                            	...
                            	<div class="filter">
                            		...
                            		<div class="event_filter_wrapper">
                            			<input id="party" class="event_filter" name="event_filter_sel"  type="checkbox" value="all" data-type="state" checked="true" />
                                ...
                                <table id="example" class="display" style="width:100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>2011-04-25</td>
                                            <td>$320,800</td>
                                            <td><a href="" style="color:#f5613b">Click Here</a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>

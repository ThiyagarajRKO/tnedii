    ...
    'events' => [
        ...
        'beforeRenderTheme'  => function (Theme $theme) {
            ...
            $theme
                ...
                ->usePath()->add('tvet.js', 'js/tvet.js', ['jquery'], [], $version);
            ...
            $theme
                ...
                /* Customized by Vijayaragavan.Amabalam*/
             ...
             $theme->asset()->container('footer')->usePath()->add('carousel-js', 'plugins/owl-carousel/js/owl.carousel.min.js');

            $theme->asset()->container('footer')->usePath()->add('components-js', 'js/components.js', [], [], $version);

            if (function_exists('shortcode')) {
                $theme->composer(['page', 'post', 'index'], function (\Impiger\Shortcode\View\View $view) {
                    $view->withShortcodes();
                });
            }
        },
